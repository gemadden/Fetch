...
while is_game_running:
    ...
    if game_mode == "instructions":
        ...
        text_surface = name_font.render("Goal: Catch 40 tennis balls before 3 reach the ground!", True, [0, 0, 0,])
    ...
    if game_mode == "second title screen":
        ...
        if level_one_complete:
            screen.blit(miles_icon, level_one_rect)
        else:
    ...
    if game_mode == "level_three":
        ...
        if not paused_mode_1:
            ...
            objects = new_objects
            for object in objects:
                object.centery = object.centery + 10

            enemies = new_enemies
            for enemy in enemies:
                enemy.centery = enemy.centery + 10
        # new_objects = []
        # for object in objects: # loop through all objects
